...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        self.ca0 = DHAM(channel=2048)
        self.ca1 = DHAM(channel=1024)
        self.ca2 = DHAM(channel=512)
    ...
    def _forward_impl(self, x: Tensor) -> Tensor:
        ...
        feature_a = self.layer1(self.ca0(x))

        feature_b = self.layer2(self.ca1(feature_a))

        feature_c = self.layer3(self.ca2(feature_b))
